...
public class MainViewYoungestMenuState implements MenuState {
    private final FileService fileService;
    private final CompetitionContext competitionContext;

    public MainViewYoungestMenuState() {
    ...
    public void viewMenu() {
        ...
        fileService.displayMaxForColumn(4); // год рождения max -> самые молодые
